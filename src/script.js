...
const collectEmployees = function() {
  ...
  let AddDataEmpl = true;
  const Empldata = [];
  
  while (AddDataEmpl) {
    
    let firstNameString = window.prompt("Enter First Name");
    let lastNameString = window.prompt("Enter Laster Name");
    let salaryString = window.prompt("Enter Salary");
